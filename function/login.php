...
$sql = "SELECT [id], [username], [email] FROM [master].[dbo].[users_table] WHERE [email]= '$email' AND [password]= '$password'";
...
if($obj != null){
    ...
    echo '{"error":0,"result":"Welcome back '.$obj->username.'", "id":"'.$obj->id.'", "username":"'.$obj->username.'","email":"'.$obj->email.'"}';
